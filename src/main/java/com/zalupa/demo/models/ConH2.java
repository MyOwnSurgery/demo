...
*/
    public static void Create(Connection con, Statement stmt) throws SQLException, IOException, ClassNotFoundException {
        ...
        stmt.executeUpdate("Create table Client (\r\n" + "CLIENT_ID INT(11) NOT NULL,\r\n" + "CLIENT_NAME VARCHAR(50) NOT NULL,\r\n"
                ...
                + ");\r\n" + "Create table Track (\r\n" + "TRACK_TRACK_ID INT(11), \r\n"+"TRACK_TRACK_NAME VARCHAR(50) NOT NULL,\r\n"
                + "TRACK_TRACK_SIZE FLOAT(6),\r\n" + "TRACK_TRACK_DURATION FLOAT(6),\r\n" + "PRIMARY KEY (TRACK_TRACK_NAME),\r\n" + "FOREIGN KEY (TRACK_TRACK_ID) REFERENCES TRACKLIST(TRACKLIST_TRACKLIST_ID));");
        ...
        stmt.executeUpdate("INSERT INTO TRACK VALUES (1,'track1',100,100);\n" + "INSERT INTO TRACK VALUES (1,'track2',100,100);\n" + "INSERT INTO TRACK VALUES (1,'track3',100,100);\n" + "INSERT INTO TRACK VALUES (1,'track4',100,100);\n" + "INSERT INTO TRACK VALUES (1,'track5',100,100);\n" + "INSERT INTO TRACK VALUES (2,'track6',100,100);\n"+"INSERT INTO TRACK VALUES (2,'track7',100,100);\n" + "INSERT INTO TRACK VALUES (2,'track8',100,100);\n"+ "INSERT INTO TRACK VALUES (2,'track9',100,100);\n"+ "INSERT INTO TRACK VALUES (2,'track10',100,100);\n"+ "INSERT INTO TRACK VALUES (3,'track11',100,100);\n"+ "INSERT INTO TRACK VALUES (3,'track12',100,100);\n"+ "INSERT INTO TRACK VALUES (3,'track13',100,100);\n"
                + "INSERT INTO TRACK VALUES (3,'track14',100,100);\n"+ "INSERT INTO TRACK VALUES (3,'track15',100,100);\n"+ "INSERT INTO TRACK VALUES (4,'track16',100,100);\n"+ "INSERT INTO TRACK VALUES (4,'track17',100,100);\n"+ "INSERT INTO TRACK VALUES (4,'track18',100,100);\n"+ "INSERT INTO TRACK VALUES (4,'track19',100,100);\n"+ "INSERT INTO TRACK VALUES (4,'track20',100,100);\n"+ "INSERT INTO TRACK VALUES (5,'track21',100,100);\n"+ "INSERT INTO TRACK VALUES (5,'track22',100,100);\n"+ "INSERT INTO TRACK VALUES (5,'track23',100,100);\n"+ "INSERT INTO TRACK VALUES (5,'track24',100,100);\n"+ "INSERT INTO TRACK VALUES (5,'track25',100,100);\n"+ "INSERT INTO TRACK VALUES (6,'track26',100,100);\n"
                + "INSERT INTO TRACK VALUES (6,'track27',100,100);\n"+ "INSERT INTO TRACK VALUES (6,'track28',100,100);\n"+ "INSERT INTO TRACK VALUES (6,'track29',100,100);\n"+ "INSERT INTO TRACK VALUES (6,'track30',100,100);\n");
